...
export default createReactClass({
  ...
  handleHide() {
    ...
    if (this.props.onBlur) {
      ...
      const domNode: any = ReactDOM.findDOMNode(this.refs.hiddenInput);
  ...
  handleInputChange() {
    const domNode: any = ReactDOM.findDOMNode(this.refs.input);
    const originalValue = domNode.value;
  ...
  render() {
    ...
    return (
      <InputGroup
        ref="inputGroup"
        bsPrefix={this.props.showClearButton ? this.props.bsClass : ''}
      ...
      >
        <Overlay
          ...
          target={(): any => ReactDOM.findDOMNode(this.refs.input)}
