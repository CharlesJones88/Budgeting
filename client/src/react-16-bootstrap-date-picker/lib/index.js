  ...
  render: function render() {
    ...
    for (var i = 0; i < 9; i++) {
      ...
      if (showWeeks) {
        ...
        week.unshift(React.createElement(
          'td',
          {
            key: 7,
    ...
    var weekColumn = showWeeks ? React.createElement('td', {
    ...
    return React.createElement(
      ...
      this.props.showTodayButton && React.createElement(
        'tfoot',
        null,
        React.createElement(
          'tr',
...
export default createReactClass({
  ...
  render: function render() {
    ...
    var calendarHeader = React.createElement(CalendarHeader, {
    ...
    return React.createElement(
      ...
      React.createElement(
        Overlay,
        {
          ...
          container: function container() {
            return _this2.props.calendarContainer || ReactDOM.findDOMNode(_this2.refs.overlayContainer);
          },
          target: function target() {
            return ReactDOM.findDOMNode(_this2.refs.input);
          },
      ...
      React.createElement('input', { ref: 'hiddenInput', type: 'hidden', id: this.props.id, name: this.props.name, value: this.state.value || '', 'data-formattedvalue': this.state.value ? this.state.inputValue : '' }),
      this.props.showClearButton && !this.props.customControl && React.createElement(
        InputGroup.Addon,
        {
